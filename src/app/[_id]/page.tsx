...
const ProductPage = async ({searchParams}: Props) => {
  ...
  return (
    <Container
    className="flex items-center flex-col md:flex-row px-4"
    >
        <div
        className="w-full md:w-1/2 overflow-hidden bg-zinc-50 flex items-center justify-center p-10"
        >
            <Image 
            src={product?.image} 
        ...
        >
            ...
            <button
            className="bg-designColor/80 text-zinc-700 px-6 py-2 
            font-medium rounded-md hover:bg-designColor
            hover:text-black cursor-pointer duration-200 hove:shadow-lg w-40 my-2"
            >
                add to cart
            </button>
            {
            ...
            <p>Category: <span className="font-semibold">{product?.brand}</span></p>
